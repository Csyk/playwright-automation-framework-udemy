...
public class Login_Steps {
    ...
    public void i_type_a_username(String username) {
        browserManager.page.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Username")).fill(username);
    }

    @And("I type a password {word}")
    public void i_type_a_password(String password) {
        browserManager.page.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Password")).fill(password);
    }

    @And("I click on the login button")
    public void i_click_on_the_login_button() {
        browserManager.page.onDialog(dialog -> {
